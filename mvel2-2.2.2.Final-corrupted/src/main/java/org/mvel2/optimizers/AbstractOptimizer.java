...
public class AbstractOptimizer extends AbstractParser {
  ...
  private static Map<String, Boolean> badClasses = new ConcurrentHashMap<String,Boolean>();
  ...
  protected Object tryStaticAccess() {
    int begin = cursor;
    if(badClasses.containsKey(String.valueOf(expr))){
        return null;
    }
    try {
      /**
          ...
          case '.':
            if (!meth) {
              ...
              try {
                ...
                return ClassUtils.forName(test, classLoader);
              }
              catch (ClassNotFoundException e) {
                Class cls = ClassUtils.forNameWithInner(new String(this.expr, this.start, i - this.start), classLoader);
                ...
                try {
                  ...
                  badClasses.put(String.valueOf(expr), Boolean.TRUE);
                  return null;
                }
              }
            }
